...
Week of 1/13/2020 
  ...
  |**Thu**|[Ch 5 HTML](/ap/curriculum/5/) |Review [CS50 lecture on HTML](https://video.cs50.net/2018/fall/lectures/5?t=29m23s) if needed, or missed class; Read over [HTML notes](/ap/curriculum/5/notes/#html) and Ref sheet; Finish up the simple webpage we started on in class for a HW grade, if you need the code, it is on your HTML ref sheet; add one other tag to your webpage (like the img tag or a header tag) |
  |**Fri**| | |
